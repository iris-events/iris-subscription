...
public class SubscriptionManager {
    ...
    public void unsubscribe(final String sessionId, final Resource resource) {
        subscriptionCollection.remove(sessionId, resource.resourceType(), resource.resourceId());
    }
}
